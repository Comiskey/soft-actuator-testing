...
const double KP = 0.4; // Clark's defaults: Kp = 0.1, Ki = 0.001, Kd = 0.0. Good starting point
...
// Example sawtooth trajectory
// const float TIMES[] = {0, 100, 1000, 2000, 2100, 3000}; // milliseconds
// const double PRESSURES[] = {0, 1, 10, 20, 0, 0}; // PSI

// Example ramp (burst) trajectory w/o interp helper
// const float TIMES[] = {0, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 8100}; // milliseconds
// const double PRESSURES[] = {0, 5, 5, 10, 10, 15, 15, 20, 20, 0}; // PSI
// Example ramp (burst) trajectory
// const float TIMES[] = {0, 100, 1000, 2000, 2100, 3000, 4000, 4100, 5000, 6000, 6100, 7000, 8000}; // milliseconds
// const double PRESSURES[] = {0, 1, 5, 5, 6, 10, 10, 11, 15, 15, 16, 20, 20}; // PSI
